...
import { Box, Grid, Avatar, Grommet, Button, Text } from "grommet";
    ...
    <Grommet theme={theme}>
      ...
      >
        <Box background="000000" gridArea="sidebar" align="center">
          <Avatar src={"./troy.jpg"} size="300px"></Avatar>
        </Box>
        ...
        <Box background="000000" gridArea="footer"></Box>
      </Grid>
      ...
      >
        <Box background="000000" height="medium">
          <Text size="large" alignSelf="center" align="center">
            Current Listings
          </Text>
